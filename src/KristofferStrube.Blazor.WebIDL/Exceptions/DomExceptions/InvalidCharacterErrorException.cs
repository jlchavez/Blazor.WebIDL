namespace KristofferStrube.Blazor.WebIDL.Exceptions
{
    ...
    public class InvalidCharacterErrorException : DOMException
    {
        ...
        public InvalidCharacterErrorException(string message, string? jSStackTrace, Exception innerException) : base(message, InvalidCharacterError, jSStackTrace, innerException) { }
    }
}
