namespace KristofferStrube.Blazor.WebIDL.Exceptions
{
    ...
    public class InvalidStateErrorException : DOMException
    {
        ...
        public InvalidStateErrorException(string message, string? jSStackTrace, Exception innerException) : base(message, InvalidStateError, jSStackTrace, innerException) { }
    }
}
