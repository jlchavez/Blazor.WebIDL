namespace KristofferStrube.Blazor.WebIDL.Exceptions
{
    ...
    public class NoModificationAllowedErrorException : DOMException
    {
        ...
        public NoModificationAllowedErrorException(string message, string? jSStackTrace, Exception innerException) : base(message, NoModificationAllowedError, jSStackTrace, innerException) { }
    }
}
