namespace KristofferStrube.Blazor.WebIDL.Exceptions
{
    ...
    public class TransactionInactiveErrorException : DOMException
    {
        ...
        public TransactionInactiveErrorException(string message, string? jSStackTrace, Exception innerException) : base(message, TransactionInactiveError, jSStackTrace, innerException) { }
    }
}
