namespace KristofferStrube.Blazor.WebIDL.Exceptions
{
    ...
    public class WrongDocumentErrorException : DOMException
    {
        ...
        public WrongDocumentErrorException(string message, string? jSStackTrace, Exception innerException) : base(message, WrongDocumentError, jSStackTrace, innerException) { }
    }
}
